<div class="w-full bg-neutral-25 window1:px-window1 window2:px-window2  tablet2:px-tablet px-[16px] py-[64px]">
    <div class="w-full flex flex-col pb-[16px]">
        <img src="<?php echo get_template_directory_uri() . '/images/indexImg/header-color.png' ?>" class="w-[122px] h-[32px]" width="122" height="32" alt="map">
    </div>
    <div class="hidden window1:flex w-full text-black pb-[24px]">
        <div class="w-[55%] flex flex-col">
            ...
            <div class="flex pb-[16px]"><a href="https://www.facebook.com/PolaronSolar/" class="hover:cursor-pointer" target="_blank">
                    <img src="<?php echo get_template_directory_uri() . '/css/icon/facebooktw.svg' ?>" class="h-[36px] w-[36px] undefined" alt="logo"></a><span class="padding w-[27px]"></span><a href="https://www.instagram.com/accounts/login/?next=/polaronsolar/" class="hover:cursor-pointer" target="_blank">
                    <img src="<?php echo get_template_directory_uri() . '/css/icon/instw.svg' ?>" class="h-[36px] w-[36px] undefined" alt="logo"></a><span class="padding w-[27px]"></span><a href="https://x.com/polaronsolar" class="hover:cursor-pointer" target="_blank">
                    <img src="<?php echo get_template_directory_uri() . '/css/icon/twittertw.svg' ?>" class="h-[36px] w-[36px] undefined" alt="logo"></a><span class="padding w-[27px]"></span><a href="https://www.youtube.com/channel/UCjMZ3-4H0mQQdeWlp96zMug" class="hover:cursor-pointer" target="_blank">
                    <img src="<?php echo get_template_directory_uri() . '/css/icon/youtubetw.svg' ?>" class="h-[36px] w-[36px] undefined" alt="logo"></a><span class="padding w-[27px]"></span><a href="https://www.linkedin.com/company/polaron-solartech-corporation/" class="hover:cursor-pointer" target="_blank">
                    <img src="<?php echo get_template_directory_uri() . '/css/icon/linkedintw.svg' ?>" class="h-[36px] w-[36px] undefined" alt="logo"></a><span class="padding w-[27px]"></span><a href="https://www.tiktok.com/@polaronsolar" class="hover:cursor-pointer" target="_blank">
                    <img src="<?php echo get_template_directory_uri() . '/css/icon/tiktoktw.svg' ?>" class="h-[36px] w-[36px] undefined" alt="logo"></a></div>
            <div class="flex w-[95%]">
        ...
        <div class="flex flex-col w-full text-black pb-[48px]">
            <div class="flex-1 flex flex-col">
                ...
                <div class="flex flex-wrap gap-[27px]"><a href="https://www.facebook.com/PolaronSolar/" class="hover:cursor-pointer" target="_blank">
                        <img src="<?php echo get_template_directory_uri() . '/css/icon/facebooktw.svg' ?>" class="h-[36px] w-[36px] undefined" alt="logo"></a><a href="https://www.instagram.com/accounts/login/?next=/polaronsolar/" class="hover:cursor-pointer" target="_blank">
                        <img src="<?php echo get_template_directory_uri() . '/css/icon/instw.svg' ?>" class="h-[36px] w-[36px] undefined" alt="logo"></a><a href="https://x.com/polaronsolar" class="hover:cursor-pointer" target="_blank">
                        <img src="<?php echo get_template_directory_uri() . '/css/icon/twittertw.svg' ?>" class="h-[36px] w-[36px] undefined" alt="logo"></a><a href="https://www.youtube.com/channel/UCjMZ3-4H0mQQdeWlp96zMug" class="hover:cursor-pointer" target="_blank">
                        <img src="<?php echo get_template_directory_uri() . '/css/icon/youtubetw.svg' ?>" class="h-[36px] w-[36px] undefined" alt="logo"></a><a href="https://www.linkedin.com/company/polaron-solartech-corporation/" class="hover:cursor-pointer" target="_blank">
                        <img src="<?php echo get_template_directory_uri() . '/css/icon/linkedintw.svg' ?>" class="h-[36px] w-[36px] undefined" alt="logo"></a><a href="https://www.tiktok.com/@polaronsolar" class="hover:cursor-pointer" target="_blank">
                        <img src="<?php echo get_template_directory_uri() . '/css/icon/tiktoktw.svg' ?>" class="h-[36px] w-[36px] undefined" alt="logo"></a></div>
            </div>
        </div>
        <div class="flex flex-col w-full text-black pb-[48px]">
